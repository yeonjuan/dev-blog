...
- 어떤 문자가 존재할 것으로 예상하지만, 그 문자를 사용하지 않을 때 `eatSomething`을 사용합니다.
...
컨텍스트를 바탕으로 한 제안은 더 공감할 수 있고 실행할 수 있는 것처럼 느껴질 것입니다.
...
에러 처리는 중요하며, 더 중요한 것은 사용자가 에러 메시지를 수정하는 방법을 알 수 있도록 의미 있는 에러 메시지를 사용하는 것입니다.
